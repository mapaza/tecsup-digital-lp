...
import { Title, Subtitle, OverlayBody, StickyContainer, Container, ScrollDown, Model } from './styles'
    ...
    <Container id="first">
      <StickyContainer>
        <OverlayBody>
          ...
          >
            Acelere la <span className="outline">transformación digital</span> de su organización
          </Title>
          <Subtitle
            initial={{ opacity: 0 }}
        ...
        <Model
          ref={meshRef}
          pathModel='/hidrociclon2/hidrociclon.glb'
